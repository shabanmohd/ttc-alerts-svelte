...
<style>
  ...
  :global(.switch-track:hover) {
    box-shadow: 0 0 0 3px hsl(var(--ring) / 0.15);
  }
  :global(.switch-track:active) {
  ...
  :global(.switch-checked:hover) {
    background-color: hsl(var(--foreground) / 0.85) !important;
    border-color: hsl(var(--foreground) / 0.85) !important;
  }
  ...
  :global(.dark .switch-track:hover) {
  ...
  :global(.dark .switch-unchecked:hover) {
    background-color: hsl(var(--muted-foreground) / 0.45) !important;
    border-color: hsl(var(--muted-foreground) / 0.55) !important;
  }
  ...
  :global(.dark .switch-checked:hover) {
